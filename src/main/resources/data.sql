...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age,phone,description,pesel,phisiotherapist_id) values ( 1,'Krakowska', 'Kraków', 'Polska', 'PiotrNowak@o2.pl', 'Piotr', 'Nowak','m',34,'699254436','Przykładowy opis pacjenta','61081702122','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (2, 'Sandomierska', 'Sandomierz', 'Polska', 'Gustowski@o2.pl', 'Bernard', 'Gustowski','m',56,'737654753','Przykładowy opis pacjenta','98102107842','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (3,'Adampolska', 'Warszawa', 'Polska', 'Wysocki@o2.pl', 'Aleksander', 'Wysocki','m',74,'699024930','Przykładowy opis pacjenta','25080113875','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (4,'Amundsena', 'Kraków', 'Polska', 'Maciejewski@o2.pl', 'Grzegorz', 'Maciejewski','m',15,'504253425','Przykładowy opis pacjenta','98061506256','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (5,'Gołdapska', 'Lublin', 'Polska', 'Sikorski@o2.pl', 'Wiktor', 'Sikorski','m',35,'534066889','Przykładowy opis pacjenta','75070214402','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (6,'Hafciarska', 'Warszawa', 'Polska', 'Bąk@o2.pl', 'Nikodem', 'Bąk','m',63,'729244587','Przykładowy opis pacjenta','46091714910','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (7,'Elektryczna', 'Wrocław', 'Polska', 'Sadowski@o2.pl', 'Łukasz', 'Sadowski','m',55,'881283656','Przykładowy opis pacjenta','67032612988','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (8,'Chodkiewicza', 'Gustawów', 'Polska', 'Cieślik@o2.pl', 'Michał', 'Cieślik','m',42,'793127581','Przykładowy opis pacjenta','77102103003','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (9,'Bieniewicka', 'Sopot', 'Polska', 'Krupa@o2.pl', 'Maksymilian', 'Krupa','m',71,'660562876','Przykładowy opis pacjenta','86092703812','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (10,'Jakobinów', 'Warszawa', 'Polska', 'Chojnacki@o2.pl', 'Łukasz', 'Chojnacki','m',47,'727784184','Przykładowy opis pacjenta','58031700279','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (11,'Falenicka', 'Gdańsk', 'Polska', 'Kowalczyk@o2.pl', 'Kacper', 'Kowalczyk','m',24,'739364992','Przykładowy opis pacjenta','40080903840','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (12,'Jontka', 'Lublin', 'Polska', 'Kowalski@o2.pl', 'Adrian', 'Kowalski','m',64,'722435188','Przykładowy opis pacjenta','63072100748','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (13,'Anecińska', 'Kraków', 'Polska', 'Jastrzębski@o2.pl', 'Antoni', 'Jastrzębski','m',21,'729713984','Przykładowy opis pacjenta','23090108065','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (14,'Bakalarska ', 'Myślinowice', 'Polska', 'Czajkowska@o2.pl', 'Julia', 'Czajkowska','k',37,'734180340','Przykładowy opis pacjenta','75090814574','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (15,'Dziewosłęby', 'Warszawa', 'Polska', 'Marszałek@o2.pl', 'Alicja', 'Marszałek','k',32,'699284354','Przykładowy opis pacjenta','56070817598','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (16,'Juraty', 'Opole', 'Polska', 'Czajka@o2.pl', 'Maja', 'Czajka','k',58,'789575568','Przykładowy opis pacjenta','25090116787','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (17,'Nalewki', 'Kraków', 'Polska', 'Makowski@o2.pl', 'Grzegorz', 'Makowski','m',51,'883665896','Przykładowy opis pacjenta','31070919181','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (18,'Malwowa', 'Poznań', 'Polska', 'Mazurek@o2.pl', 'Aleksandra', 'Mazurek','k',28,'780519198','Przykładowy opis pacjenta','31082318774','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (19,'Atlasowa', 'Wrocław', 'Polska', 'Barańska@o2.pl', 'Katarzyna', 'Barańska','k',31,'660872208','Przykładowy opis pacjenta','64062408095','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (20,'Czynszowa', 'Warszawa', 'Polska', 'Patrycja@o2.pl', 'Patrycja', 'Dudek','k',57,'690508886','Przykładowy opis pacjenta','54103010402','1');
...
insert into patient (id,address, city, country, email, first_name, last_name,gender,age, phone,description,pesel,phisiotherapist_id) values (21,'Drużynowa', 'Gdynia', 'Polska', 'Kacprzak@o2.pl', 'Zofia', 'Kacprzak','k',18,'699341961','Przykładowy opis pacjenta','40081405624','1');
